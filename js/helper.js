...
var HTMLheaderRole = "<span class='orange-text'><b>%data%</b></span><hr/>";
...
var HTMLworkImage = "<img src='%data%' class='expic'>";
...
$(document).ready(function() {
  $('button').click(function() {
    var iName = inName("Surajkumar Harikumar") || function(){};
    $('#name').html(iName);  
    console.log(iName);
  });
})
